...
import pytest
from gcalcli.auth.authorization import (
...
@pytest.fixture
def open_path():
    return 'gcalcli.auth.authorization.open'
...
@pytest.fixture
def mock_mkdir():
    path = 'gcalcli.auth.authorization.Path'
...
def mock_open_function(token_json):
    path = 'gcalcli.auth.authorization.open'
...
@patch('gcalcli.auth.authorization.Flow')
